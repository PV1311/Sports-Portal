...
<%
  String message = (String)request.getAttribute("plan");
...
<form method="post" action="/SportsPortal/Plan" style="background-color:#91cbe2;">
      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
           <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Plan Form</h3>
            <form>
              ...
              <div class="form-outline">
                    <label class="form-label" for="planCharge">Charge</label>
                    <input type="number" name="txtcharge" id="planCharge" class="form-control form-control-lg" />
                  </div>
                  
              <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Services</label>
                    <textarea class="form-control" name="txtservices" id="exampleFormControlTextarea1" rows="auto"></textarea>
                  </div>
